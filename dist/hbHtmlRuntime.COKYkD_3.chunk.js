const c="hb_higanbana_html_bridge_v1",s="/*__HB_HTML_COMPAT__*/";function h(t){const n=String(t.origin??"").trim(),e=!!t.forceBaseHref;return`
<script>${s}
(() => {
  const G = globalThis;
...
<\/script>
`}function d(t,n={}){const e=String(t??"");if(!e.trim()||e.includes(s))return e;const r=h(n),a=/<head\\b[^>]*>/i;if(a.test(e))return e.replace(a,o=>o+r);const i=/<html\\b[^>]*>/i;return i.test(e)?e.replace(i,o=>o+`<head>${r}</head>`):r+e}export{c as H,d as i};
