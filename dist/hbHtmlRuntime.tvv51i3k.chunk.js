...
(() => {
  ...
  try {
    ...
    // 明确移除旧别名，避免外部继续依赖多入口。
    try {
      delete G.Higanbana.overwriteProject;
      delete G.Higanbana.overwriteCurrentProject;
      delete G.Higanbana.importZipAndOverwriteProject;
      delete G.Higanbana.importZipAndOverwriteCurrentProject;
    } catch {
      // ignore
    }
